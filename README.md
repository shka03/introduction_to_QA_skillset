...
私はQAエンジニアとして4年以上の実務経験を積み、現在は少人数体制の中で品質保証を戦略的に推進しています。

「再現性のある品質活動で、プロダクトの理想像を創り出す貢献のQA」という信念のもと、予防的QAやE2Eテスト自動化により、プロセス全体の品質向上に取り組んでいます。

テストプロセス改善では以下のような施策を実施：
- ISTQB準拠のアプローチをベースに設計。
- アジャイル開発に即したテスト観点や探索的テストの導入提案。
...
| Specialist | アジャイルテスター（CT-AT） | ✅2025/12 取得済 | アジャイル開発での品質に関する知見を深め実務で活かす |
| Advanced | テストマネージャー（CTAL-TM） | 🔜2026以降予定 | スクラム開発におけるQA体制の計画設計・予防QA強化を目的に学習中。 |
| Specialist | テスト自動化（CT-TAE） | 🔜2026以降予定(受験可能後) | MagicPod自動化の属人化解消・チーム共有方針の策定支援に連動予定。 |
| Specialist | 自動車（CTFL-AuT） | 🔜2026以降予定  | 他業界の品質知見を得て教養を深める |

# 🤝 副業での経験

- **QA体制構築に関するアドバイザー（2025年3月～12月）**  
